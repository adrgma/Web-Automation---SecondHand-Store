...
WebUI.callTestCase(findTestCase('Pages/page_login/input_email'), [('email') : 'putriyulina45@gmail.com'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/page_login/input_password'), [('password') : 'Puyulputriyulina123'], FailureHandling.STOP_ON_FAILURE)
