...
WebUI.callTestCase(findTestCase('Pages/page_productpage/tab_diminati/navigate_to_produk_langsung_tolak'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/page_productpage/tab_diminati/click_tolak_transaksi_langsung'), [:], FailureHandling.STOP_ON_FAILURE)
