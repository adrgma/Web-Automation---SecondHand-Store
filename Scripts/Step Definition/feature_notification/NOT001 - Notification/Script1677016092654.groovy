...
WebUI.callTestCase(findTestCase('Pages/page_login/input_email'), [('email') : 'afkoke@gmail.com'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/page_login/input_password'), [('password') : '1234567890'], FailureHandling.STOP_ON_FAILURE)
